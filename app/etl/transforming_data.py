    ...
    for coluna, data_type in tabela_aux.dtypes_finais_colunas.items():
        if data_type.is_(pl.String):
            tabela_aux.set_expr(
                ...
                .str.to_lowercase()
                .str.strip_chars()
                .str.replace_all("á", "a", literal=True)
                .str.replace_all("â", "a", literal=True)
                .str.replace_all("ã", "a", literal=True)
                .str.replace_all("ê", "e", literal=True)
                .str.replace_all("é", "a", literal=True)
                .str.replace_all("í", "i", literal=True)
                .str.replace_all("õ", "o", literal=True)
                .str.replace_all("ó", "o", literal=True)
                .str.replace_all("ú", "u", literal=True)
